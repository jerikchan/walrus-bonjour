      ...
      >
        ...
        <nav className="mt-6 space-y-4">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/admin">Admin</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx(
          'rounded-full bg-zinc-100 object-cover dark:bg-zinc-800 shadow-md border',
          ...
          >
            <div className="relative flex gap-4">
              ...
              <div className="flex justify-end md:flex-1 gap-4">
                ...
                <div className="pointer-events-auto h-10 flex items-center justify-center">
                  <ConnectButton />
                </div>
              </div>
            </div>
